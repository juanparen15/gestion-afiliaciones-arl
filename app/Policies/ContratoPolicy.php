...
class ContratoPolicy
{
    ...
    {
        return $user->can('force_delete_any_contrato');
    }
    ...
    {
        return $user->can('restore_any_contrato');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Contrato $contrato): bool
    {
        return $user->can('replicate_contrato');
    }
    ...
    {
        return $user->can('reorder_contrato');
    }
}
