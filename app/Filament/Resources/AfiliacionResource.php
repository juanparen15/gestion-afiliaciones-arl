...
class AfiliacionResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Gestión de Afiliaciones ARL';
                            ...
                            Forms\Components\Section::make('Duración del Contrato')
                                ...
                                ->schema([
                                    ...
                                    Forms\Components\DatePicker::make('fecha_inicio')
                                        ...
                                        ->required()
                                        ->minDate(fn(string $operation) => $operation === 'edit' ? null : now()->addDay()->startOfDay())
                                        ->displayFormat('d/m/Y')
                                        ->native(false)
                                    ...
                                    Forms\Components\DatePicker::make('fecha_fin')
                                        ...
                                        ->required()
                                        ->minDate(fn(string $operation) => $operation === 'edit' ? null : now()->addDay(2)->startOfDay())
                                        ->displayFormat('d/m/Y')
                                        ->native(false)
                            ...
                            Forms\Components\Section::make('Datos de la ARL')
                                ...
                                ->schema([
                                    ...
                                    Forms\Components\DatePicker::make('fecha_afiliacion_arl')
                                        ...
                                        ->displayFormat('d/m/Y')
                                        ->minDate(fn(string $operation) => $operation === 'edit' ? null : now()->addDay())
                                        ->visible(fn() => Auth::user()->hasRole(['super_admin', 'SSST']))
                                        ->native(false)
                                        ->prefixIcon('heroicon-o-calendar'),
