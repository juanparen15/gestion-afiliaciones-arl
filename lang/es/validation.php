...
return [
    ...
    */
    ...
    'custom' => [
        'numero_documento' => [
            'unique' => 'Este número de documento ya se encuentra registrado en el sistema.',
            'required' => 'El número de documento es obligatorio.',
        ],
        'nombre_contratista' => [
            'required' => 'El nombre completo del contratista es obligatorio.',
        ],
        'tipo_documento' => [
        ...
        'dependencia_id' => [
            'required' => 'La dependencia/secretaría es obligatoria.',
        ],
        'objeto_contractual' => [
            'required' => 'El objeto del contrato es obligatorio.',
        ],
        'valor_contrato' => [
            'required' => 'El valor total del contrato es obligatorio.',
            'numeric' => 'El valor del contrato debe ser un número.',
        ],
        'honorarios_mensual' => [
            'required' => 'Los honorarios mensuales son obligatorios.',
            'numeric' => 'Los honorarios mensuales deben ser un número.',
        ],
        'ibc' => [
            'required' => 'El IBC (Ingreso Base de Cotización) es obligatorio.',
            'numeric' => 'El IBC debe ser un número.',
        ],
        'fecha_inicio' => [
        ...
        'contrato_pdf_o_word' => [
            'required' => 'Debe cargar el contrato en PDF o Word.',
        ],
        'nombre_arl' => [
            'required' => 'El nombre de la ARL es obligatorio.',
        ],
        'tipo_riesgo' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'telefono_contratista' => 'número de celular',
        ...
        'area_id' => 'área',
        'objeto_contractual' => 'objeto del contrato',
        'supervisor_contrato' => 'supervisor del contrato',
        'valor_contrato' => 'valor del contrato',
        'honorarios_mensual' => 'honorarios mensuales',
        'ibc' => 'IBC',
        'meses_contrato' => 'meses de contrato',
        'dias_contrato' => 'días de contrato',
        'fecha_inicio' => 'fecha de inicio',
        'fecha_fin' => 'fecha de finalización',
        'contrato_pdf_o_word' => 'contrato PDF o Word',
        'nombre_arl' => 'nombre de la ARL',
        'tipo_riesgo' => 'nivel de riesgo',
        'numero_afiliacion_arl' => 'número de afiliación ARL',
        'fecha_afiliacion_arl' => 'fecha de afiliación ARL',
        'fecha_terminacion_afiliacion' => 'fecha de terminación de afiliación',
        'pdf_arl' => 'PDF del afiliado en ARL',
        'estado' => 'estado',
